...
@onready var ingredient_effect_1 = $MarginContainer/HBoxContainer/VBoxContainer/IngredientEffect1 as RichTextLabel
@onready var ingredient_effect_2 = $MarginContainer/HBoxContainer/VBoxContainer/IngredientEffect2 as RichTextLabel
